...
public class AvlGTree<K, V> extends AbstractMap<K, V> implements
    ...
    public V remove(Object key) {	
        ...
        if(root != null) {
        	AvlNode<K,V> n = root.remove(k);
        	if(n != null) {
        		fixAfterModification(n);
        		size--;
        		modCount++;
        		ret = n.value;
        	}
    ...
    static final class AvlNode<K, V> implements Map.Entry<K, V> {
        ...
        public AvlNode<K,V> remove(K key) {
            ...
            if(cmp != 0 && (left == null || right == null)) {
            	return null;
            } else if(cmp == 0) {
            	return this;
            } else if( cmp < 0) {
            	AvlNode<K,V> ret = left.remove(key);
            	if(ret != null) {
            		if(ret.equals(left.getValue())) {
            			left = left.removeHelp();
            	...
            	AvlNode<K,V> ret = right.remove(key);
            	if(ret != null) {
            		if(ret.equals(right.getValue())) {
            			right = right.removeHelp();
        ...
        private AvlNode<K,V> removeHelp(){
        	AvlNode<K,V> ret = null;
        	if(left != null && right != null) {
        		AvlNode<K,V> n = this.right;
        		boolean advance = true;
        		while(advance){
        			if(n.left != null && n.left.left != null) {
        				n = n.left;
        			} else if(n.left != null && n.left.left == null) {
